...
pub fn generate_uniforms(camera: &Camera, viewport_size: glam::Vec2) -> Uniforms {
    Uniforms {
        ...
        screen: [viewport_size.x as f32, viewport_size.y as f32, 0.0, 0.0],
        camera: [camera.aspect_ratio as f32, camera.zoom_factor as f32, camera.near_far.x, camera.near_far.y],
    }
}